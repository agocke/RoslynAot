    ...
    public readonly partial struct SyntaxTreeAnalysisContext
    {
        ...
        public Text.TextSpan? FilterSpan
        {
            get
            {
                ...
                int status = vtbl.SyntaxTreeAnalysisContext_get_FilterSpan(__RoslynAotGetHandle(controlVtbl), out long result);
        ...
        public bool IsGeneratedCode
        {
            get
            {
                global::RoslynAot.Abi.IRoslynControlVtbl controlVtbl = __RoslynAotGetControlVtbl();
                global::RoslynAot.Abi.ISyntaxTreeAnalysisContextVtbl vtbl = __RoslynAotGetVtbl();
                int status = vtbl.SyntaxTreeAnalysisContext_get_IsGeneratedCode(__RoslynAotGetHandle(controlVtbl), out int result);
                global::RoslynAot.RoslynFacade.RoslynFacadeRuntime.ThrowIfFailed(controlVtbl, status);
                return result != 0;
            }
        }
        ...
        public AnalyzerOptions Options
        {
            get
            {
                global::RoslynAot.Abi.IRoslynControlVtbl controlVtbl = __RoslynAotGetControlVtbl();
                global::RoslynAot.Abi.ISyntaxTreeAnalysisContextVtbl vtbl = __RoslynAotGetVtbl();
                int status = vtbl.SyntaxTreeAnalysisContext_get_Options(__RoslynAotGetHandle(controlVtbl), out long result);
                global::RoslynAot.RoslynFacade.RoslynFacadeRuntime.ThrowIfFailed(controlVtbl, status);
        ...
        public SyntaxTree Tree
        {
            get
            {
                global::RoslynAot.Abi.IRoslynControlVtbl controlVtbl = __RoslynAotGetControlVtbl();
                global::RoslynAot.Abi.ISyntaxTreeAnalysisContextVtbl vtbl = __RoslynAotGetVtbl();
                int status = vtbl.SyntaxTreeAnalysisContext_get_Tree(__RoslynAotGetHandle(controlVtbl), out long result);
                global::RoslynAot.RoslynFacade.RoslynFacadeRuntime.ThrowIfFailed(controlVtbl, status);
