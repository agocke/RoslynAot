    ...
    public readonly partial struct SymbolAnalysisContext
    {
        ...
        public Text.TextSpan? FilterSpan
        {
            get
            {
                global::RoslynAot.Abi.IRoslynControlVtbl controlVtbl = __RoslynAotGetControlVtbl();
                global::RoslynAot.Abi.ISymbolAnalysisContextVtbl vtbl = __RoslynAotGetVtbl();
                int status = vtbl.SymbolAnalysisContext_get_FilterSpan(__RoslynAotGetHandle(controlVtbl), out long result);
                global::RoslynAot.RoslynFacade.RoslynFacadeRuntime.ThrowIfFailed(controlVtbl, status);
        ...
        public SyntaxTree? FilterTree
        {
            get
            {
                global::RoslynAot.Abi.IRoslynControlVtbl controlVtbl = __RoslynAotGetControlVtbl();
                global::RoslynAot.Abi.ISymbolAnalysisContextVtbl vtbl = __RoslynAotGetVtbl();
                int status = vtbl.SymbolAnalysisContext_get_FilterTree(__RoslynAotGetHandle(controlVtbl), out long result);
                global::RoslynAot.RoslynFacade.RoslynFacadeRuntime.ThrowIfFailed(controlVtbl, status);
        ...
        public bool IsGeneratedCode
        {
            get
            {
                global::RoslynAot.Abi.IRoslynControlVtbl controlVtbl = __RoslynAotGetControlVtbl();
                global::RoslynAot.Abi.ISymbolAnalysisContextVtbl vtbl = __RoslynAotGetVtbl();
                int status = vtbl.SymbolAnalysisContext_get_IsGeneratedCode(__RoslynAotGetHandle(controlVtbl), out int result);
                global::RoslynAot.RoslynFacade.RoslynFacadeRuntime.ThrowIfFailed(controlVtbl, status);
                return result != 0;
            }
        }
        ...
        public AnalyzerOptions Options
        {
            get
            {
                global::RoslynAot.Abi.IRoslynControlVtbl controlVtbl = __RoslynAotGetControlVtbl();
                global::RoslynAot.Abi.ISymbolAnalysisContextVtbl vtbl = __RoslynAotGetVtbl();
                int status = vtbl.SymbolAnalysisContext_get_Options(__RoslynAotGetHandle(controlVtbl), out long result);
                global::RoslynAot.RoslynFacade.RoslynFacadeRuntime.ThrowIfFailed(controlVtbl, status);
