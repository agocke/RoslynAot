...
[GeneratedComClass]
internal sealed partial class IncrementalGeneratorRunStepVtblDispatcher : IIncrementalGeneratorRunStepVtbl
{
    private readonly RoslynInterop _owner;

    public IncrementalGeneratorRunStepVtblDispatcher(RoslynInterop owner)
    {
        _owner = owner ?? throw new ArgumentNullException(nameof(owner));
    }

    public unsafe int IncrementalGeneratorRunStep_get_Name(
        long receiver,
        nint buffer,
        int bufferLength,
        out int requiredLength)
    {
        ...
        try
        {
            ...
            string? __roslynAotValue = _owner.Objects.GetObject<global::Microsoft.CodeAnalysis.IncrementalGeneratorRunStep>(receiver).Name;
