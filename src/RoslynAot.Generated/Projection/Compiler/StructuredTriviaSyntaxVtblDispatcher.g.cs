...
[GeneratedComClass]
internal sealed partial class StructuredTriviaSyntaxVtblDispatcher : IStructuredTriviaSyntaxVtbl
{
    private readonly RoslynInterop _owner;

    public StructuredTriviaSyntaxVtblDispatcher(RoslynInterop owner)
    {
