...
[GeneratedComClass]
internal sealed partial class EmbeddedTextVtblDispatcher : IEmbeddedTextVtbl
{
    private readonly RoslynInterop _owner;

    public EmbeddedTextVtblDispatcher(RoslynInterop owner)
    {
        _owner = owner ?? throw new ArgumentNullException(nameof(owner));
    }

    public int EmbeddedText_get_ChecksumAlgorithm(
        long receiver,
        out int result)
    {
        ...
        try
        {
            result = (int)_owner.Objects.GetObject<global::Microsoft.CodeAnalysis.EmbeddedText>(receiver).ChecksumAlgorithm;
    ...
    public unsafe int EmbeddedText_get_FilePath(
        long receiver,
        nint buffer,
        int bufferLength,
        out int requiredLength)
    {
        ...
        try
        {
            ...
            string? __roslynAotValue = _owner.Objects.GetObject<global::Microsoft.CodeAnalysis.EmbeddedText>(receiver).FilePath;
