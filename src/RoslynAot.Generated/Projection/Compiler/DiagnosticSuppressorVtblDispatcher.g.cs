...
[GeneratedComClass]
internal sealed partial class DiagnosticSuppressorVtblDispatcher : IDiagnosticSuppressorVtbl
{
    private readonly RoslynInterop _owner;

    public DiagnosticSuppressorVtblDispatcher(RoslynInterop owner)
    {
        _owner = owner ?? throw new ArgumentNullException(nameof(owner));
    }

    public int DiagnosticAnalyzer_GetHashCode(
        long receiver,
        out int result)
    {
    ...
    public unsafe int DiagnosticAnalyzer_ToString(
        long receiver,
        nint buffer,
        int bufferLength,
        out int requiredLength)
    {
        ...
        try
        {
            ...
            string? __roslynAotValue = _owner.Objects.GetObject<global::Microsoft.CodeAnalysis.Diagnostics.DiagnosticAnalyzer>(receiver).ToString();
