...
[GeneratedComClass]
internal sealed partial class TypedConstantExtensionsVtblDispatcher : ITypedConstantExtensionsVtbl
{
    private readonly RoslynInterop _owner;

    public TypedConstantExtensionsVtblDispatcher(RoslynInterop owner)
    {
        _owner = owner ?? throw new ArgumentNullException(nameof(owner));
    }

    public unsafe int TypedConstantExtensions_ToCSharpString(
        long constant,
        nint buffer,
        int bufferLength,
        out int requiredLength)
    {
        ...
        try
        {
            ...
            string? __roslynAotValue = global::Microsoft.CodeAnalysis.CSharp.TypedConstantExtensions.ToCSharpString(_owner.Objects.GetValue<global::Microsoft.CodeAnalysis.TypedConstant>(constant));
