...
[GeneratedComClass]
internal sealed partial class DocumentationProviderVtblDispatcher : IDocumentationProviderVtbl
{
    private readonly RoslynInterop _owner;

    public DocumentationProviderVtblDispatcher(RoslynInterop owner)
    {
