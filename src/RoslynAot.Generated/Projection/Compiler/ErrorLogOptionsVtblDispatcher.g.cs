...
[GeneratedComClass]
internal sealed partial class ErrorLogOptionsVtblDispatcher : IErrorLogOptionsVtbl
{
    private readonly RoslynInterop _owner;

    public ErrorLogOptionsVtblDispatcher(RoslynInterop owner)
    {
        _owner = owner ?? throw new ArgumentNullException(nameof(owner));
    }

    public unsafe int ErrorLogOptions_get_Path(
        long receiver,
        nint buffer,
        int bufferLength,
        out int requiredLength)
    {
        ...
        try
        {
            ...
            string? __roslynAotValue = _owner.Objects.GetObject<global::Microsoft.CodeAnalysis.ErrorLogOptions>(receiver).Path;
    ...
    public int ErrorLogOptions_get_SarifVersion(
        long receiver,
        out int result)
    {
        ...
        try
        {
            result = (int)_owner.Objects.GetObject<global::Microsoft.CodeAnalysis.ErrorLogOptions>(receiver).SarifVersion;
            return RoslynAbi.Success;
        }
        catch (global::System.Exception exception)
        {
