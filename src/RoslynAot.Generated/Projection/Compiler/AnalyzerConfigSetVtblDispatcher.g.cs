...
[GeneratedComClass]
internal sealed partial class AnalyzerConfigSetVtblDispatcher : IAnalyzerConfigSetVtbl
{
    private readonly RoslynInterop _owner;

    public AnalyzerConfigSetVtblDispatcher(RoslynInterop owner)
    {
        ...
        out long result)
    {
        ...
        try
        {
            result = _owner.Objects.AddValue(_owner.Objects.GetObject<global::Microsoft.CodeAnalysis.AnalyzerConfigSet>(receiver).GlobalConfigOptions);
            return RoslynAbi.Success;
        }
        catch (global::System.Exception exception)
        {
