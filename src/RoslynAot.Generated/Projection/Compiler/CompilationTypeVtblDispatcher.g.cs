...
[GeneratedComClass]
internal sealed partial class CompilationTypeVtblDispatcher : ICompilationTypeVtbl
{
    private readonly RoslynInterop _owner;

    public CompilationTypeVtblDispatcher(RoslynInterop owner)
    {
        _owner = owner ?? throw new ArgumentNullException(nameof(owner));
    }

    public unsafe int Compilation_GetRequiredLanguageVersion(
        long diagnostic,
        nint buffer,
        int bufferLength,
        out int requiredLength)
    {
        ...
        try
        {
            ...
            string? __roslynAotValue = global::Microsoft.CodeAnalysis.Compilation.GetRequiredLanguageVersion(_owner.Objects.GetObject<global::Microsoft.CodeAnalysis.Diagnostic>(diagnostic));
