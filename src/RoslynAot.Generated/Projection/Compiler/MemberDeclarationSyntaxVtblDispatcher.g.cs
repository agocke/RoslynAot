...
[GeneratedComClass]
internal sealed partial class MemberDeclarationSyntaxVtblDispatcher : IMemberDeclarationSyntaxVtbl
{
    private readonly RoslynInterop _owner;

    public MemberDeclarationSyntaxVtblDispatcher(RoslynInterop owner)
    {
