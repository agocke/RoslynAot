...
[GeneratedComClass]
internal sealed partial class IUtf8StringOperationVtblDispatcher : IIUtf8StringOperationVtbl
{
    private readonly RoslynInterop _owner;

    public IUtf8StringOperationVtblDispatcher(RoslynInterop owner)
    {
        _owner = owner ?? throw new ArgumentNullException(nameof(owner));
    }

    public unsafe int IUtf8StringOperation_get_Value(
        long receiver,
        nint buffer,
        int bufferLength,
        out int requiredLength)
    {
        ...
        try
        {
            ...
            string? __roslynAotValue = _owner.Objects.GetObject<global::Microsoft.CodeAnalysis.Operations.IUtf8StringOperation>(receiver).Value;
