...
[GeneratedComClass]
internal sealed partial class SimpleBaseTypeSyntaxVtblDispatcher : ISimpleBaseTypeSyntaxVtbl
{
    private readonly RoslynInterop _owner;

    public SimpleBaseTypeSyntaxVtblDispatcher(RoslynInterop owner)
    {
    ...
    public int SimpleBaseTypeSyntax_Accept_8dcaf9e7(
        long receiver,
        long visitor)
    {
        ...
        try
        {
            _owner.Objects.GetObject<global::Microsoft.CodeAnalysis.CSharp.Syntax.SimpleBaseTypeSyntax>(receiver).Accept(_owner.Objects.GetObject<global::Microsoft.CodeAnalysis.CSharp.CSharpSyntaxVisitor>(visitor));
            return RoslynAbi.Success;
        }
        catch (global::System.Exception exception)
        {
    ...
    public int SimpleBaseTypeSyntax_Update(
        long receiver,
        long @type,
        out long result)
    {
        ...
        try
        {
            result = _owner.Objects.AddObject(_owner.Objects.GetObject<global::Microsoft.CodeAnalysis.CSharp.Syntax.SimpleBaseTypeSyntax>(receiver).Update(_owner.Objects.GetObject<global::Microsoft.CodeAnalysis.CSharp.Syntax.TypeSyntax>(@type)));
            return RoslynAbi.Success;
        }
        catch (global::System.Exception exception)
        {
    ...
    public int SimpleBaseTypeSyntax_WithType(
        long receiver,
        long @type,
        out long result)
    {
        ...
        try
        {
            result = _owner.Objects.AddObject(_owner.Objects.GetObject<global::Microsoft.CodeAnalysis.CSharp.Syntax.SimpleBaseTypeSyntax>(receiver).WithType(_owner.Objects.GetObject<global::Microsoft.CodeAnalysis.CSharp.Syntax.TypeSyntax>(@type)));
            return RoslynAbi.Success;
        }
        catch (global::System.Exception exception)
        {
    ...
    public int SimpleBaseTypeSyntax_get_Type(
        long receiver,
        out long result)
    {
        ...
        try
        {
            result = _owner.Objects.AddObject(_owner.Objects.GetObject<global::Microsoft.CodeAnalysis.CSharp.Syntax.SimpleBaseTypeSyntax>(receiver).Type);
            return RoslynAbi.Success;
        }
        catch (global::System.Exception exception)
        {
