...
internal sealed partial class CSharpSyntaxTreeVtblDispatcher : ICSharpSyntaxTreeVtbl
{
    ...
    public int CSharpSyntaxTree_GetDiagnostics_7c051836(
        long receiver,
        long nodeOrToken,
        out long result)
    {
    ...
    public int CSharpSyntaxTree_GetDiagnostics_26ae4016(
        long receiver,
        long token,
        out long result)
    {
    ...
    public int CSharpSyntaxTree_GetDiagnostics_2f26461c(
        long receiver,
        long trivia,
        out long result)
    {
