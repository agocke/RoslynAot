...
[GeneratedComClass]
internal sealed partial class BaseArgumentListSyntaxVtblDispatcher : IBaseArgumentListSyntaxVtbl
{
    private readonly RoslynInterop _owner;

    public BaseArgumentListSyntaxVtblDispatcher(RoslynInterop owner)
    {
