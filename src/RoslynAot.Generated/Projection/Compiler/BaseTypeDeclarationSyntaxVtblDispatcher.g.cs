...
[GeneratedComClass]
internal sealed partial class BaseTypeDeclarationSyntaxVtblDispatcher : IBaseTypeDeclarationSyntaxVtbl
{
    private readonly RoslynInterop _owner;

    public BaseTypeDeclarationSyntaxVtblDispatcher(RoslynInterop owner)
    {
