...
[GeneratedComClass]
internal sealed partial class AssemblyIdentityComparerVtblDispatcher : IAssemblyIdentityComparerVtbl
{
    private readonly RoslynInterop _owner;

    public AssemblyIdentityComparerVtblDispatcher(RoslynInterop owner)
    {
