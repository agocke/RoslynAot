...
namespace Microsoft.CodeAnalysis
{
    public readonly partial struct LineMapping : System.IEquatable<LineMapping>
    {
        ...
        public override readonly string? ToString()
        {
            ...
            return global::AnalyzeAot.RoslynFacade.RoslynFacadeRuntime.ReadUtf16String(controlVtbl, (nint buffer, int bufferLength, out int requiredLength) => vtbl.LineMapping_ToString(__analyzeAotReceiver, buffer, bufferLength, out requiredLength));
        }
