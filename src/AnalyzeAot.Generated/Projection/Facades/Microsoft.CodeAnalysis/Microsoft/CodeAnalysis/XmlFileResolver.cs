    ...
    public partial class XmlFileResolver : XmlReferenceResolver
    {
        ...
        public string? BaseDirectory
        {
            get
            {
                ...
                global::AnalyzeAot.Abi.IXmlFileResolverVtbl vtbl = __AnalyzeAotGetVtbl();
                long __analyzeAotReceiver = __AnalyzeAotGetHandle(controlVtbl);
                return global::AnalyzeAot.RoslynFacade.RoslynFacadeRuntime.ReadUtf16String(controlVtbl, (nint buffer, int bufferLength, out int requiredLength) => vtbl.XmlFileResolver_get_BaseDirectory(__analyzeAotReceiver, buffer, bufferLength, out requiredLength));
            }
        }
        ...
        public static XmlFileResolver Default
        {
            get
            {
                ...
                global::AnalyzeAot.Abi.IXmlFileResolverTypeVtbl vtbl = global::AnalyzeAot.RoslynFacade.RoslynVtblFactory.GetXmlFileResolverTypeVtbl(controlVtbl);
        ...
        public override int GetHashCode()
        {
            global::AnalyzeAot.Abi.IRoslynControlVtbl controlVtbl = __AnalyzeAotGetControlVtbl();
            global::AnalyzeAot.Abi.IXmlFileResolverVtbl vtbl = __AnalyzeAotGetVtbl();
            int status = vtbl.XmlFileResolver_GetHashCode(__AnalyzeAotGetHandle(controlVtbl), out int result);
            global::AnalyzeAot.RoslynFacade.RoslynFacadeRuntime.ThrowIfFailed(controlVtbl, status);
            return result;
        }
        ...
        private global::AnalyzeAot.Abi.IXmlFileResolverVtbl? __analyzeAotVtbl;
        private long __analyzeAotHandle;
        internal XmlFileResolver(global::AnalyzeAot.Abi.IRoslynControlVtbl controlVtbl, global::AnalyzeAot.Abi.IXmlFileResolverVtbl vtbl, long handle) : base(controlVtbl, vtbl, handle)
        {
        ...
        internal global::AnalyzeAot.Abi.IXmlFileResolverVtbl __AnalyzeAotGetVtbl() => __analyzeAotVtbl ?? throw new System.InvalidOperationException("This Roslyn facade value has no vtbl.");
        ...
        internal static XmlFileResolver __AnalyzeAotCreateProxy(global::AnalyzeAot.Abi.IRoslynControlVtbl controlVtbl, long handle) => new XmlFileResolver(controlVtbl, global::AnalyzeAot.RoslynFacade.RoslynVtblFactory.GetXmlFileResolverVtbl(controlVtbl), handle);
    }
}
