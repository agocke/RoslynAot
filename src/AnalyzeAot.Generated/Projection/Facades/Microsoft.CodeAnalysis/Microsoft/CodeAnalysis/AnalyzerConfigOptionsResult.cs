...
namespace Microsoft.CodeAnalysis
{
    public readonly partial struct AnalyzerConfigOptionsResult
    {
        ...
        private readonly global::AnalyzeAot.Abi.IAnalyzerConfigOptionsResultVtbl? __analyzeAotVtbl;
        private readonly long __analyzeAotHandle;
        internal AnalyzerConfigOptionsResult(global::AnalyzeAot.Abi.IRoslynControlVtbl controlVtbl, global::AnalyzeAot.Abi.IAnalyzerConfigOptionsResultVtbl vtbl, long handle)
        {
            this = default;
        ...
        internal global::AnalyzeAot.Abi.IAnalyzerConfigOptionsResultVtbl __AnalyzeAotGetVtbl()
        {
            if (__analyzeAotVtbl is not null)
                return __analyzeAotVtbl;
            if (__analyzeAotHandle == 0)
                return global::AnalyzeAot.RoslynFacade.RoslynVtblFactory.GetAnalyzerConfigOptionsResultVtbl(global::AnalyzeAot.RoslynFacade.RoslynFacadeRuntime.GetCurrentControlVtbl());
        ...
        internal static AnalyzerConfigOptionsResult __AnalyzeAotCreateProxy(global::AnalyzeAot.Abi.IRoslynControlVtbl controlVtbl, long handle) => new AnalyzerConfigOptionsResult(controlVtbl, global::AnalyzeAot.RoslynFacade.RoslynVtblFactory.GetAnalyzerConfigOptionsResultVtbl(controlVtbl), handle);
    }
}
