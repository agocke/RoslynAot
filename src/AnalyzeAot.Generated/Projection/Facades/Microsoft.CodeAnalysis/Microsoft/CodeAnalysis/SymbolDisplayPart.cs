...
namespace Microsoft.CodeAnalysis
{
    public readonly partial struct SymbolDisplayPart
    {
        ...
        public override readonly string ToString()
        {
            ...
            return global::AnalyzeAot.RoslynFacade.RoslynFacadeRuntime.ReadUtf16String(controlVtbl, (nint buffer, int bufferLength, out int requiredLength) => vtbl.SymbolDisplayPart_ToString(__analyzeAotReceiver, buffer, bufferLength, out requiredLength))!;
        }
