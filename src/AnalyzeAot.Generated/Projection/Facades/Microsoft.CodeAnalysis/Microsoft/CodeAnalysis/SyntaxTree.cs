    ...
    public abstract partial class SyntaxTree
    {
        ...
        public ParseOptions Options
        {
            get
            {
                ...
                int status = vtbl.SyntaxTree_get_Options(__AnalyzeAotGetHandle(controlVtbl), out long result);
        ...
        public override string ToString()
        {
            ...
            return global::AnalyzeAot.RoslynFacade.RoslynFacadeRuntime.ReadUtf16String(controlVtbl, (nint buffer, int bufferLength, out int requiredLength) => vtbl.SyntaxTree_ToString(__analyzeAotReceiver, buffer, bufferLength, out requiredLength))!;
        }
