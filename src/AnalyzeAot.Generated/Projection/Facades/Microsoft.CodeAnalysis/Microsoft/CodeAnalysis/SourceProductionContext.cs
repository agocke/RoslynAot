...
namespace Microsoft.CodeAnalysis
{
    public readonly partial struct SourceProductionContext
    {
        ...
        public readonly void ReportDiagnostic(Diagnostic diagnostic)
        {
            ...
            global::AnalyzeAot.Abi.ISourceProductionContextVtbl vtbl = __AnalyzeAotGetVtbl();
            int status = vtbl.SourceProductionContext_ReportDiagnostic(__AnalyzeAotGetHandle(controlVtbl), diagnostic.__AnalyzeAotGetHandle(controlVtbl));
        ...
        private readonly global::AnalyzeAot.Abi.ISourceProductionContextVtbl? __analyzeAotVtbl;
        private readonly long __analyzeAotHandle;
        internal SourceProductionContext(global::AnalyzeAot.Abi.IRoslynControlVtbl controlVtbl, global::AnalyzeAot.Abi.ISourceProductionContextVtbl vtbl, long handle)
        {
            this = default;
        ...
        internal global::AnalyzeAot.Abi.ISourceProductionContextVtbl __AnalyzeAotGetVtbl()
        {
            if (__analyzeAotVtbl is not null)
                return __analyzeAotVtbl;
            if (__analyzeAotHandle == 0)
                return global::AnalyzeAot.RoslynFacade.RoslynVtblFactory.GetSourceProductionContextVtbl(global::AnalyzeAot.RoslynFacade.RoslynFacadeRuntime.GetCurrentControlVtbl());
        ...
        internal static SourceProductionContext __AnalyzeAotCreateProxy(global::AnalyzeAot.Abi.IRoslynControlVtbl controlVtbl, long handle) => new SourceProductionContext(controlVtbl, global::AnalyzeAot.RoslynFacade.RoslynVtblFactory.GetSourceProductionContextVtbl(controlVtbl), handle);
    }
}
