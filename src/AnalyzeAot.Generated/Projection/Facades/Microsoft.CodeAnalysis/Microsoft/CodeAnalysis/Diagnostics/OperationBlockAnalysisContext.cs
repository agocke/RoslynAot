    ...
    public readonly partial struct OperationBlockAnalysisContext
    {
        ...
        public Text.TextSpan? FilterSpan
        {
            get
            {
                ...
                global::AnalyzeAot.Abi.IOperationBlockAnalysisContextVtbl vtbl = __AnalyzeAotGetVtbl();
                int status = vtbl.OperationBlockAnalysisContext_get_FilterSpan(__AnalyzeAotGetHandle(controlVtbl), out long result);
        ...
        public SyntaxTree FilterTree
        {
            get
            {
                global::AnalyzeAot.Abi.IRoslynControlVtbl controlVtbl = __AnalyzeAotGetControlVtbl();
                global::AnalyzeAot.Abi.IOperationBlockAnalysisContextVtbl vtbl = __AnalyzeAotGetVtbl();
                int status = vtbl.OperationBlockAnalysisContext_get_FilterTree(__AnalyzeAotGetHandle(controlVtbl), out long result);
                global::AnalyzeAot.RoslynFacade.RoslynFacadeRuntime.ThrowIfFailed(controlVtbl, status);
        ...
        public bool IsGeneratedCode
        {
            get
            {
                global::AnalyzeAot.Abi.IRoslynControlVtbl controlVtbl = __AnalyzeAotGetControlVtbl();
                global::AnalyzeAot.Abi.IOperationBlockAnalysisContextVtbl vtbl = __AnalyzeAotGetVtbl();
                int status = vtbl.OperationBlockAnalysisContext_get_IsGeneratedCode(__AnalyzeAotGetHandle(controlVtbl), out int result);
                global::AnalyzeAot.RoslynFacade.RoslynFacadeRuntime.ThrowIfFailed(controlVtbl, status);
                return result != 0;
            }
        }
        ...
        public AnalyzerOptions Options
        {
            get
            {
                global::AnalyzeAot.Abi.IRoslynControlVtbl controlVtbl = __AnalyzeAotGetControlVtbl();
                global::AnalyzeAot.Abi.IOperationBlockAnalysisContextVtbl vtbl = __AnalyzeAotGetVtbl();
                int status = vtbl.OperationBlockAnalysisContext_get_Options(__AnalyzeAotGetHandle(controlVtbl), out long result);
                global::AnalyzeAot.RoslynFacade.RoslynFacadeRuntime.ThrowIfFailed(controlVtbl, status);
        ...
        public readonly void ReportDiagnostic(Diagnostic diagnostic)
        {
            global::AnalyzeAot.Abi.IRoslynControlVtbl controlVtbl = __AnalyzeAotGetControlVtbl();
            global::AnalyzeAot.Abi.IOperationBlockAnalysisContextVtbl vtbl = __AnalyzeAotGetVtbl();
            int status = vtbl.OperationBlockAnalysisContext_ReportDiagnostic(__AnalyzeAotGetHandle(controlVtbl), diagnostic.__AnalyzeAotGetHandle(controlVtbl));
            global::AnalyzeAot.RoslynFacade.RoslynFacadeRuntime.ThrowIfFailed(controlVtbl, status);
        }

        private readonly global::AnalyzeAot.Abi.IRoslynControlVtbl? __analyzeAotControlVtbl;
        private readonly global::AnalyzeAot.Abi.IOperationBlockAnalysisContextVtbl? __analyzeAotVtbl;
        private readonly long __analyzeAotHandle;
        internal OperationBlockAnalysisContext(global::AnalyzeAot.Abi.IRoslynControlVtbl controlVtbl, global::AnalyzeAot.Abi.IOperationBlockAnalysisContextVtbl vtbl, long handle)
        {
            this = default;
        ...
        internal global::AnalyzeAot.Abi.IOperationBlockAnalysisContextVtbl __AnalyzeAotGetVtbl()
        {
            if (__analyzeAotVtbl is not null)
                return __analyzeAotVtbl;
            if (__analyzeAotHandle == 0)
                return global::AnalyzeAot.RoslynFacade.RoslynVtblFactory.GetOperationBlockAnalysisContextVtbl(global::AnalyzeAot.RoslynFacade.RoslynFacadeRuntime.GetCurrentControlVtbl());
        ...
        internal static OperationBlockAnalysisContext __AnalyzeAotCreateProxy(global::AnalyzeAot.Abi.IRoslynControlVtbl controlVtbl, long handle) => new OperationBlockAnalysisContext(controlVtbl, global::AnalyzeAot.RoslynFacade.RoslynVtblFactory.GetOperationBlockAnalysisContextVtbl(controlVtbl), handle);
    }
}
