    ...
    public readonly partial struct AdditionalFileAnalysisContext
    {
        ...
        public AdditionalText AdditionalFile
        {
            get
            {
                ...
                int status = vtbl.AdditionalFileAnalysisContext_get_AdditionalFile(__AnalyzeAotGetHandle(controlVtbl), out long result);
                global::AnalyzeAot.RoslynFacade.RoslynFacadeRuntime.ThrowIfFailed(controlVtbl, status);
                return AdditionalText.__AnalyzeAotCreateProxy(controlVtbl, result);
            }
        }
        ...
        public AnalyzerOptions Options
        {
            get
            {
                global::AnalyzeAot.Abi.IRoslynControlVtbl controlVtbl = __AnalyzeAotGetControlVtbl();
                global::AnalyzeAot.Abi.IAdditionalFileAnalysisContextVtbl vtbl = __AnalyzeAotGetVtbl();
                int status = vtbl.AdditionalFileAnalysisContext_get_Options(__AnalyzeAotGetHandle(controlVtbl), out long result);
                global::AnalyzeAot.RoslynFacade.RoslynFacadeRuntime.ThrowIfFailed(controlVtbl, status);
