    ...
    public sealed partial class ErrorLogOptions
    {
        ...
        public string Path
        {
            get
            {
                ...
                return global::AnalyzeAot.RoslynFacade.RoslynFacadeRuntime.ReadUtf8String(controlVtbl, (nint buffer, int bufferLength, out int requiredLength) => vtbl.ErrorLogOptions_get_Path(__analyzeAotReceiver, buffer, bufferLength, out requiredLength))!;
            }
        }
