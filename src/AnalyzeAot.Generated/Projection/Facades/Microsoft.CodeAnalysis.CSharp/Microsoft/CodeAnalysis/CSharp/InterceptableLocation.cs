    ...
    public partial interface InterceptableLocation : System.IEquatable<InterceptableLocation>
    {
        public string Data
        {
            get
            {
                ...
                return global::AnalyzeAot.RoslynFacade.RoslynFacadeRuntime.ReadUtf16String(controlVtbl, (nint buffer, int bufferLength, out int requiredLength) => vtbl.InterceptableLocation_get_Data(__analyzeAotReceiver, buffer, bufferLength, out requiredLength))!;
            }
        }
        ...
        public string GetDisplayLocation()
        {
            ...
            global::AnalyzeAot.Abi.IInterceptableLocationVtbl vtbl = __AnalyzeAotGetVtbl();
            long __analyzeAotReceiver = __AnalyzeAotGetHandle(controlVtbl);
            return global::AnalyzeAot.RoslynFacade.RoslynFacadeRuntime.ReadUtf16String(controlVtbl, (nint buffer, int bufferLength, out int requiredLength) => vtbl.InterceptableLocation_GetDisplayLocation(__analyzeAotReceiver, buffer, bufferLength, out requiredLength))!;
        }
