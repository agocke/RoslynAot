...
internal static class ProjectionOutputEmitter
{
        ...
        string facadesRoot)
    {
        ...
        WriteGeneratedFile(
            Path.Combine(
                coreDirectory,
                "AnalyzeAotProjectionFriends.g.cs"),
            """
    ...
    private static string EmitAbiVtbl(VtblProjection vtbl)
    {
        ...
        builder.AppendLine();
        builder.AppendLine("namespace AnalyzeAot.Abi;");
        builder.AppendLine();
    ...
    private static string EmitCompilerDispatcher(VtblProjection vtbl)
    {
        ...
        builder.AppendLine();
        builder.AppendLine("namespace AnalyzeAot.CompilerHost;");
        builder.AppendLine();
    ...
    private static string EmitVtblFactory(ProjectionModel model)
    {
        ...
        builder.AppendLine("using AnalyzeAot.Abi;");
        builder.AppendLine();
        builder.AppendLine("namespace AnalyzeAot.RoslynFacade;");
        builder.AppendLine();
